...
public class User {
	...
	public User(String username, String password, int gender, boolean moderator, boolean sponsor, boolean lock,
	...
	public User(int user_id, String username, String password, int gender, boolean moderator, boolean sponsor,
