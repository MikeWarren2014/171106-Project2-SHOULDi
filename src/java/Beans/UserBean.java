...
public class UserBean implements Serializable {
	...
	private List<MessageBean> user_comments;
	...
	public List<MessageBean> getUser_comments() {
		return user_comments;
	}

	public void setUser_comments(ArrayList<MessageBean> user_comments) {
	...
	public UserBean(int user_id, String username, String password, int gender, boolean moderator, boolean lock,
			...
			ArrayList<MessageBean> user_comments, int score) {
		super();
		this.user_id = user_id;
		this.username = username;
		this.password = password;
